...
import com.Gamestalk.springnggamestalk.dto.RefreshTokenRequest;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please Activate your Account",
                user.getEmail(), "Thank you for signing up to Gamestalk, " +
                "please click on the below url to activate your account : " +
                "http://gamestalkbackend-env.eba-c3mvh9em.eu-central-1.elasticbeanstalk.com/api/auth/accountVerification/" + token));
    }
    ...
    private void fetchUserAndEnable(VerificationToken verificationToken) {
        ...
        User user = userRepository.findByUsername(username).orElseThrow(() -> new SpringGamestalkException("User not found with name - " + username));
    ...
    public void verifyAccount(String token) {
        ...
        fetchUserAndEnable(verificationToken.orElseThrow(() -> new SpringGamestalkException("Invalid Token")));
    }
