...
class MailService {
    ...
    void sendMail(NotificationEmail notificationEmail) {
        MimeMessagePreparator messagePreparator = mimeMessage -> {
            ...
            messageHelper.setFrom("springgamestalk@email.com");
        ...
        try {
            ...
            throw new SpringGamestalkException("Exception occurred when sending mail to " + notificationEmail.getRecipient(), e);
        }
    }
